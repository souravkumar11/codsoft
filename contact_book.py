...
root.resizable(0,0)
contactlist = [
    ['Ram Singh','9148568978'],
    ['Sourav kumar', '7061555979'],
    ]
...
Button(root,text="UPDATE", font='Helvetica 18 bold',bg='#e8c1c7',command = UpdateDetail, padx=20).place(x= 50, y=260)
Button(root,text="DELETE", font='Helvetica 18 bold',bg='#e8c1c7',command = Delete_Entry, padx=20).place(x= 50, y=325)
Button(root,text="VIEW", font='Helvetica 18 bold',bg='#e8c1c7', command = VIEW).place(x= 50, y=200)
Button(root,text="SEARCH", font='Helvetica 18 bold',bg='#e8c1c7', command = search).place(x= 50, y=390)
